 ...
 * Last update: 16.02.2024 14:28:07
 * Ticket ID: ... / [1733]
 * Generated for WebSite: [https://pisnicky-akordy.cz]
 * User ID: [1]    
 * Custom ticket name: [Pisnicky-akordy.cz + DB_4 (od 16.02.2024)]
...
//    var strData = JSON.stringify(data);
    ...
    xhr.open('GET', 'https://hb.impressionmedia.cz/statistics/'+kam+'.php?configId=1733&statistics=1&groupBidsReceivedTable=4&groupRandId=5&hbmasterscript='+hbmasterscript+'&data='+strData);
